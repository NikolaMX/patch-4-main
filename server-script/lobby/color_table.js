...
var              AnonCreamy = [232,212,188];
var         AnonBloodOrange = [255, 94,  0];
var           AnonFadedBlue = [ 54, 78,102];
var          AnonNeonYellow = [208,255,  0];
var               AnonSteel = [120,120,120];
var      AnonStainlessSteel = [160,160,160];
var           AnonGlossyRed = [201,117,117];
var               AnonBrick = [161, 59, 59];
var             AnonDeepSea = [42, 40, 178];
var           AnonCamoGreen = [ 72, 89, 61];
var          AnonSoftPurple = [163,140,171];
var          AnonGreenApple = [ 50,184, 50];
var          AnonDarkOrange = [214, 99, 11];
var         AnonUglyYellow =  [150,148, 15];
var          AnonBabyYellow = [252,255,153];
var        AnonMintIceCream = [ 54,156,109];
var         AnonPurpleCandy = [ 84, 44, 94];
var         AnonTintedGreen = [192,196,159];
var            AnonNavyBlue = [ 22, 52,102];
var      AnonChocolateSpice = [ 74, 43,  0];

var CSS3x11colours = [AnonChocolateSpice, AnonNavyBlue, AnonTintedGreen, AnonPurpleCandy, AnonMintIceCream, AnonBabyYellow, AnonUglyYellow, AnonDarkOrange, AnonGreenApple, AnonSoftPurple, AnonCamoGreen, AnonDeepSea, AnonBrick, AnonGlossyRed, AnonStainlessSteel, AnonSteel, AnonNeonYellow, AnonFadedBlue, AnonBloodOrange, AnonCreamy, maroonCSS3x11, redCSS3x11,  hotPinkCSS3x11, deepPinkCSS3x11, magentaFuchsiaCSS3x11, mediumPurpleCSS3x11, tealCSS3x11, darkSeaGreenCSS3x11, darkGreenCSS3x11, aquaCSS3x11, limeCSS3x11, blueCSS3x11, powderBlueCSS3x11, cornflowerBlueCSS3x11, paleGreenCSS3x11, tanCSS3x11, purpleCSS3x11, mediumOrchidCSS3x11, lightSalmonCSS3x11, sadleBrownCSS3x11, pinkCSS3x11];
