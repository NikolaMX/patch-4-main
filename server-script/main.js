...
exports.GAMEOVER_SHUTDOWN_TIMEOUT = 60 * 60;
exports.COMMUNITY_SERVER = false;
exports.DISABLE_AI = false;
...
var envGameOverTimeoutIndex = env.indexOf('--gameover-timeout');
if (envGameOverTimeoutIndex != -1) {
    exports.GAMEOVER_SHUTDOWN_TIMEOUT = parseInt(env[envGameOverTimeoutIndex+1]);
}

var envEmptyTimeoutIndex = env.indexOf('--empty-timeout');
if (envEmptyTimeoutIndex != -1) {
    EMPTY_TIMEOUT = parseInt(env[envEmptyTimeoutIndex+1]);
console.log(EMPTY_TIMEOUT);
}

var envCommunityServersUrlIndex = env.indexOf('--community-servers-url');
if (envCommunityServersUrlIndex != -1) {
    exports.COMMUNITY_SERVER = true;
    server.startCommunityServersBeacon();
}

var envDisableAIIndex = env.indexOf('--disable-ai');
if (envDisableAIIndex != -1) {
    exports.DISABLE_AI = true;
}
